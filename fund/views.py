...
from sql_meta import fund_hold_lj_product as sql_fund_hold_lj_product
from sql_meta import fund_hold_lj_product_percent as fund_hold_lj_product_percent
# 返回基金列表
